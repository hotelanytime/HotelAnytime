  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-800 mb-1">Gallery Title</label>
          <input 
            value={form.title || ''} 
        ...
        <div className="border text-gray-600 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-4">
            <Grid className="w-5 h-5"/>
            <h3 className="font-semibold text-gray-700">Gallery Images ({(form.images || []).length})</h3>
          </div>
              ...
              {(form.images || []).map((img, i) => (
                <div key={img.url || `gallery-${i}`} className="group bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                  ...
                  <div style={{ width: '100%', height: '200px', position: 'relative', backgroundColor: '#f9fafb' }}>
                    ...
                    {/* Hover controls */}
                    <div 
                      className="absolute inset-0 bg-opacity-0 group-hover:bg-opacity-20 group-hover:bg-black flex items-center justify-center transition-all"
                    >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-lg w-full">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold text-gray-700">Edit Image Details</h3>
            ...
            {form.images && form.images[editingIndex] && (
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-700">Caption</label>
                  <input 
